...
set :rbenv_path,'/home/anjun/.rbenv'
...
set :domain, 'btdown.pw'
set :deploy_to, '/home/anjun/rails/rails-do'
set :repository, 'https://github.com/anjuncc/rails-do.git'
set :branch, 'master'
...
# Optional settings:
  set :user, 'anjun'    # Username in the server to SSH to.
  set :port, '28140'     # SSH port number.
